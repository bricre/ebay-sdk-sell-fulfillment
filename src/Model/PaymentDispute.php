...
/**
 * This type is used by the base response of the <strong>getPaymentDispute</strong>
...
class PaymentDispute extends AbstractModel
{
     ...
     * <strong>sellerResponse</strong> field will show the decision that the seller
     * made.
     *
     * @var string[]|
     */
     ...
     * described, or financial documentation/invoice.<br><br>This container is only
     * returned if the seller has provided at least one document used as evidence
     * against the payment dispute.
     *
     ...
     * payment dispute. There will always be at least one
     ...
     * order ID format to identify orders, but only the new order ID format is returned
     * in REST-based API responses. </span>.
     *
     * @var string
     */
    public $orderId = null;
     ...
     * <code>ACTION_NEEDED</code> state. For payment disputes that currently require
     * action by the seller, that same seller should look at the
     * <strong>availableChoices</strong> array to see the available
     * actions.<br/><br/>The timestamps returned here use the ISO-8601 24-hour date and
     * time format, and the time zone used is Universal Coordinated Time (UTC), also
     * known as Greenwich Mean Time (GMT), or Zulu. The ISO-8601 format looks like
     * this: <em>yyyy-MM-ddThh:mm.ss.sssZ</em>. An example would be
     * <code>2019-08-04T19:09:02.768Z</code>.
     *
     * @var string
     */
