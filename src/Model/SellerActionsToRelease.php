...
class SellerActionsToRelease extends AbstractModel
{
     ...
     * hold. A <strong>sellerActionToRelease</strong> field is returned for each
     * possible action that a seller may take. Possible actions may include providing
     * shipping/tracking information, issuing a refund, providing refund information,
