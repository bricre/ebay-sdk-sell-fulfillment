...
class Error extends AbstractModel
{
    ...
    /**
     * The name of the domain containing the service or application. For example,
     * <code>sell</code> is a domain.
     *
     * @var string
     */
    public $domain = null;
    ...
    /**
     * An expanded version of the <b>message</b> field. <br /><br /><b>Maximum
     ...
     * the end user's requested locale. <br /><br /><b>Maximum length:</b> 50
     * characters.
     *
     * @var string
     */
    ...
    /**
     * The name of the domain's subsystem or subdivision. For example,
