...
/**
 * This type is used by the <strong>evidence</strong> array that is returned in the
 * <strong>getPaymentDispute</strong> response if one or more evidential documents
 * are associated with the payment dispute.
 */
class DisputeEvidence extends AbstractModel
{
     ...
     * requested evidential document to eBay. <br/><br/>The timestamps returned here
     ...
     * Zulu. The ISO-8601 format looks like this: <em>yyyy-MM-ddThh:mm.ss.sssZ</em>. An
