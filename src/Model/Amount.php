...
class Amount extends AbstractModel
{
    ...
    /**
     * A three-letter ISO 4217 code that indicates the currency of the amount in the
     * <b>value</b> field. If currency conversion/localization is required, this is the
     * post-conversion currency of the amount in the <b>value</b> field.<br /><br
     * /><b>Default:</b> The default currency of the eBay marketplace that hosts the
     ...
     * original currency.  <br><br><i>Required in</i> the <b>amount</b> type.
     *
     * @var string
     */
    public $value = null;
