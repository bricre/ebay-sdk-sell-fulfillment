...
class ExtendedContact extends AbstractModel
{
     ...
     * old, no address is returned. <br /><br /> <span class="tablenote">
     * <strong>Note:</strong> If returned, this field contains the email address of the
     * buyer, even for Global Shipping Program shipments.</span>.
     *
     * @var string
     */
    public $email = null;
